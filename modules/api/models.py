...
class ProgressResponse(BaseModel):
    ...
    current_images: list[str] | None = Field(default=None, title="Current image", description="The current image in base64 format. opts.show_progress_every_n_steps is required for this to work.")
